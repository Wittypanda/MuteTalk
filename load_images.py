...
#Intresting part here we're loading the images along with their trainable parameters into compact representation of pickle represenation of the images
# Why Do you ask ? well that's for the Faster convergence & computationaly lighter method to compute as well as retrive from hence the approach.
