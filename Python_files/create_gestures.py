...
#creating the database for relational text assocaition with physical images on the local host
...
#Adding the images to the data base 
...
#Cpaturing the associated image with the gesture on the local machine
def store_images(g_id):
	total_pics = 1200  #capturing a total of 1200 images of the said gesture furter which doubling the size of the image using ELT/ETL methods
	hist = get_hand_hist()
